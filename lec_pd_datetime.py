""" lec_pd_datetime.py
Companion codes for the lectures on working with time-series data in Pandas
"""
import os
...
d0 = dt.datetime(year=2019, month=12, day=31)
d1 = dt.datetime(year=2020, month=1, day=1)
...
dseries = pd.to_datetime(prc['Date'], format='%Y-%m-%d')
print(dseries)
